                        ...
                        @if(isset($blogs))
                            ...
                            <div class="blog-item">
                                ...
                                <div class="blog-content">
                                    ...
                                    <p>{!! mb_substr( strip_tags(html_entity_decode($b->content)),0,300 ) !!} ...</p>
                                    <a href="{{route('site.blogdetail',['id'=>$b->blog_id ,'slug'=>\Illuminate\Support\Str::slug($b->name)])}}" class="read-more">
                                        {{__('content.goto')}}<i class="las la-long-arrow-alt-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
