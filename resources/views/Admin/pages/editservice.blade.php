                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-2">
                            ...
                            <input type="number" class="form-control"  name="desk"  value="{{$service->desk}}">
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12">
                                                ...
                                                <input type="text" class="form-control"  name="name_{{$lang->code}}"
                                                       value="{{isset(getservicecontent($service->id,$lang->code)->name)?getservicecontent($service->id,$lang->code)->name:null}}"  >
                                            </div>
                                            <div class="form-group col-12">
                                                <label for="">Açıqlama ({{$lang->name}}) </label>
                                                <textarea type="text" class="form-control mycontent"
                                                          name="content_{{$lang->code}}" >{!!isset(getservicecontent($service->id,$lang->code)->content)?getservicecontent($service->id,$lang->code)->content:null!!}</textarea>
                                            </div>
                                            <div class="form-group col-12">
                                                <label for="">Meta Açıqlama ({{$lang->name}})</label>
                                                <input type="text" class="form-control" maxlength="160" name="metacontent_{{$lang->code}}"
                                                 value="{{isset(getservicecontent($service->id,$lang->code)->meta_content)?getservicecontent($service->id,$lang->code)->meta_content:null}}">
                                            </div>
                                            <div class="form-group col-12">
                                                ...
                                                <input type="text" class="form-control" maxlength="800" name="metakeywords_{{$lang->code}}"
                                                 value="{{isset(getservicecontent($service->id,$lang->code)->meta_keywords)?getservicecontent($service->id,$lang->code)->meta_keywords:null}}">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
