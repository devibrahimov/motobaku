            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni Blog Yazısı Əlavə Edin</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="form-group col-5">
                                    ...
                                    <select name="category" required class="custom-select mr-sm-2">
                                        @foreach($categories as $cat)
                                            <option value="{{$cat->id}}"> {{isset(getblogcategorycontent($cat->id,defaultLang())->name)? getblogcategorycontent($cat->id,defaultLang())->name: ''}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
